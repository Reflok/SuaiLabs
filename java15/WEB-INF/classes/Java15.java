...
public class Java15 extends HttpServlet {
    ...
    private static String style = "style2.css";
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try (PrintWriter writer = response.getWriter()) {
            ...
            writer.println("<html>\n<head>\n<title>\nTemp2\n</title>\n");
            writer.println(String.format("<link rel=\"stylesheet\" type=\"text/css\" href=\"%s\"/>", style));
            writer.println("</head>\n");
            ...
            switch (uri) {
                ...
                case "/java15/list":
                    ...
                    if (name == null) {
                        ...
                        writer.println("<a href = \"/java15/welcome\">Add new comment</a><br>");
                    }
    ...
    private String generateList(boolean auth) {
        ...
        for (int k = list.size() - 1; k >=0; k--) {
            ...
            for (int i = 0; i < responses.size(); i++) {
                listStr.append(String.format("<p class=\"indent\">%s</p><br>by <b>%s</b>", responses.get(i), responsesAuthours.get(i)));
